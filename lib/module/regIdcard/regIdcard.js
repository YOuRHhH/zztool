...
export function regIdcard(str) {
    ...
    if (!provinceCodes.has(str.substring(0, 2)))
        return false;
    const year = parseInt(str.substring(6, 10), 10), month = parseInt(str.substring(10, 12), 10), day = parseInt(str.substring(12, 14), 10), birthDate = new Date(year, month - 1, day);
